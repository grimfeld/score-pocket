      ...
      <CardContent className="flex-1 flex flex-col items-center justify-center space-y-3 sm:space-y-4 pb-4 sm:pb-6 px-4 sm:px-6">
        ...
        <div className="flex items-center gap-3 sm:gap-4 w-full justify-center pt-2">
          <Button
            ...
            variant="outline"
            size="lg"
            className="h-14 w-14 sm:h-16 sm:w-16 md:h-20 md:w-20 p-0 aspect-square rounded-full touch-manipulation select-none border-red-500/40 bg-red-950/20 text-red-400 hover:bg-red-950/30 hover:border-red-500/60 flex items-center justify-center"
          >
          ...
          <Button
            ...
            variant="outline"
            size="lg"
            className="h-14 w-14 sm:h-16 sm:w-16 md:h-20 md:w-20 p-0 aspect-square rounded-full touch-manipulation select-none border-green-500/40 bg-green-950/20 text-green-400 hover:bg-green-950/30 hover:border-green-500/60 flex items-center justify-center"
          >
